...
import Continuous3DMockup from './Components/Mockups/Continuous3DMockup';
...
function MainRoutes({ siteMode }) {
  ...
  return (
    <Routes>
      ...
      {/* Design mockup — not linked from anywhere; view at /3d-mockup */}
      <Route path="/3d-mockup" element={<Continuous3DMockup />} />
